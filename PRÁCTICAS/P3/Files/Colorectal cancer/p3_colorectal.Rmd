...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer: No, first it would be necessary to make a genotypic-phenotypic relationship (to see if the patients present any of these SNPs), for example we could look for it in the bibliography. We also have to see the impact of these changes in the development of the disease....
